...
public class Ordynator
{
    ...
    public Ordynator(Integer idLekarza, String nazwa, Integer idStanowiska, String stanowisko, Integer idOddzialu, String oddzial)
    {
    ...
    public Ordynator(Integer idLekarza, String imie, String nazwisko, String pesel, Integer idStanowiska, String stanowisko, Integer idOddzialu, String oddzial)
    {
        this.idLekarza = new SimpleIntegerProperty(idLekarza);
